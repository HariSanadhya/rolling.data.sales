...
# Modified by: Hari Narayan Sanadhya
...
library(plyr)
library(gdata)
setwd("C:/Users/Neetu Hari/Desktop/SMU/2017-01-08 MSDS 6306 - Doing Data Science/Unit 5/Assignment/rolling.data.sales/data")
...
#   as above "bk.sale"
plot(x= log10(bk.homes$gross.sqft), y=log10(bk.homes$sale.price.n))
